...
public class HealthBar : MonoBehaviour {
    ...
    public void TakeDamage(float p_DamageAmount)
    {
        ...
        ShowHealth();
        GameAudioManager.m_Instance.PlaySound("PlayerHit", false, 1,true);
    }
    ...
    public void Heal(float p_HealAmount)
    {
        ...
        ShowHealth();
        GameAudioManager.m_Instance.PlaySound("PlayerHeal", false, m_healsoundlength  / m_healflashlength,true);
    }
